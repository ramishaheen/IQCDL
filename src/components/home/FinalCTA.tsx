  ...
  return (
    <section className="section">
      <div className="container-x">
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-quantum-indigo/30 via-void-100 to-quantum-violet/20 p-10 text-center sm:p-16">
