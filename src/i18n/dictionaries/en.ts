const en = {
  ...
  iqci: {
    ...
    bookTitle: "Open the immersive index",
    bookNote: "Tap the book to step inside — turn through each country's quantum standing, pillar by pillar.",
    bookOpen: "Open the index book",
    bookClose: "Close",
    bookHint: "Tap to open",
    quarterlyTitle: "Quarterly editions, auto-generated",
    quarterlyNote: "Every quarter an AI editorial agent compiles a new edition; a distribution agent then publishes it everywhere and sends it to the world's press to go viral.",
    generateBtn: "Generate this quarter's edition",
    generating: "The editorial agent is compiling…",
