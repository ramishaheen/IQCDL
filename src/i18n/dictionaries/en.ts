const en = {
  ...
  assistant: {
    ...
    chooseMode: "What can I help you with?",
    back: "Back",
    modeGeneralTitle: "General questions",
    modeGeneralDesc: "About IQCDL, programs, the Quantum Index & Award",
    modeTutorTitle: "Quantum tutoring & support",
    modeTutorDesc: "Personal PQC tutoring and member support",
    generalGreeting:
      "Hi! Ask me anything about IQCDL — our programs and levels, the Quantum Computing Index, the Global Quantum Award, or membership.",
    generalSuggestions: [
      "What is IQCDL?",
      "What programs and levels do you offer?",
      "What is the Quantum Computing Index (IQCI)?",
      "Tell me about the Global Quantum Award",
    ],
    leadTitle: "Let's get you started",
    leadPrompt: "Leave your details so our team can follow up — then ask away.",
    leadName: "Full name",
    leadEmail: "Email",
    leadPhone: "Contact number",
    leadSubmit: "Start chatting",
    leadError: "Please enter a valid email and contact number.",
  },
  auth: {
    title: "Welcome back",
  ...
  membership: {
    ...
    badge: {
      title: "Share your member badge",
      subtitle: "Add your IQCDL member badge to your photo and share it on Instagram or LinkedIn.",
      open: "Create my badge",
      upload: "Upload your photo",
      change: "Change photo",
      statement: "Learn leading practices using IQCDL",
      memberLabel: "IQCDL MEMBER",
      download: "Download badge",
      shareInstagram: "Share to Instagram",
      shareLinkedin: "Share on LinkedIn",
      copy: "Copy caption",
      copied: "Caption copied",
      hint: "On mobile, “Share” opens Instagram, WhatsApp and more. On desktop, download the image and attach it to your post.",
    },
  },
  about: {
    eyebrow: "About IQCDL",
  ...
  iqci: {
    ...
    scatterTitle: "Compare any two pillars",
    scatterNote: "Each point is a country. Choose the pillars for each axis — bubble size reflects the overall index score.",
    axisX: "Horizontal axis",
    axisY: "Vertical axis",
    statusLabel: "Current status",
    bookTitle: "Explore the index — country by country",
    bookNote: "Open the full index details and turn through every country's quantum standing, category by category.",
    bookOpen: "Open the country index",
    bookClose: "Close",
    bookHint: "Tap to open",
    quarterlyTitle: "Quarterly editions, auto-generated",
    quarterlyNote: "A dedicated country-data agent refreshes the index every quarter — and re-scores automatically whenever a country submits new evidence or fresh quantum news breaks. Each edition is then published everywhere and sent to the world's press.",
    liveLabel: "Live · auto-updated",
    updatedLabel: "Updated",
    generating: "The country-data agent is compiling…",
    headlineLabel: "Headline",
    highlightsLabel: "Highlights",
    distributionTitle: "Distribution agent",
    distributionNote: "Published across the web and sent to global press & news desks.",
    reachLabel: "Estimated reach",
    sentTo: "Press release sent to",
    guideTitle: "Index guidelines & methodology",
    guideNote: "How the index is built, scored and revised — the full methodology, open for anyone to read.",
    guideOpen: "Open the guidelines book",
    submit: {
      title: "Submit evidence for AI review",
      note: "Provide verifiable evidence and our neutral AI will re-review your country or entity's standing — and either adjust the ranking or request clearer evidence. Submissions require an official email, a contact number and a passport/ID copy for verification.",
      org: "Country / entity name",
      contactName: "Contact name (official)",
      officialEmail: "Official email",
      phone: "Contact number",
      country: "Country",
      pillar: "Pillar this evidence supports",
      claim: "Your claim & supporting evidence",
      claimPh: "Describe what changed and the evidence that proves it — publications, funding, deployments, metrics…",
      passport: "Passport / official ID (verification)",
      docs: "Evidence documents (PDF/images)",
      review: "Get a preliminary AI review",
      submit: "Submit for official AI review",
      scoreLabel: "Preliminary AI score",
      verdictLabel: "AI assessment",
      needsEvidence: "Clearer evidence requested",
      submitted: "Submitted. Our neutral AI jury will re-review and respond to your official email.",
      requiredNote: "Official email, contact number and a passport/ID copy are required.",
    },
    agentTitle: "How the index is scored",
    agentNote: "A dedicated country-data agent runs every quarter — and re-scores on demand whenever a country submits new evidence or quantum news breaks.",
    pipeline: [
      { step: "Country-data agent", body: "Each quarter, a dedicated AI agent gathers verified open data on every country's quantum activity." },
      { step: "Country submissions", body: "Governments and entities upload documents about their activities; the agent weighs them as evidence." },
      { step: "Neutral AI scoring", body: "A multi-agent jury scores each country against the 8-category rubric — impartially and vendor-neutrally." },
      { step: "Quarterly edition", body: "Scores are amended and a new IQCI edition is compiled automatically." },
      { step: "Distribution agent", body: "The edition is published everywhere and sent to the world's press to go viral." },
    ],
    rubricTitle: "The scoring rubric",
    rubricNote: "Eight categories, each with clear sub-criteria, scored 0–100 and combined into the overall index. The same rubric drives every quarterly revision.",
    rubricScaleLabel: "Scoring bands",
    rubricScale: [
      { band: "Leading", range: "80–100" },
      { band: "Advanced", range: "60–79" },
      { band: "Emerging", range: "40–59" },
      { band: "Nascent", range: "0–39" },
    ],
    rubric: [
      { name: "Research & publications", desc: "Scientific output and intellectual property in quantum computing.", subs: ["Peer-reviewed publications", "Patents & IP", "International collaboration"] },
      { name: "Talent & education", desc: "The pipeline of quantum-capable people.", subs: ["University & degree programs", "Workforce & training pipeline", "Reskilling & access"] },
      { name: "Investment & funding", desc: "Capital flowing into quantum capability.", subs: ["Public funding", "Private & venture capital", "Startup ecosystem"] },
      { name: "Infrastructure & hardware", desc: "Access to real quantum and supporting compute.", subs: ["Quantum hardware & access", "Cloud & HPC", "National labs & testbeds"] },
      { name: "Policy & strategy", desc: "National direction and coordination.", subs: ["National quantum strategy", "Standards engagement", "International coordination"] },
      { name: "PQC & security readiness", desc: "Preparedness for the quantum threat to cryptography.", subs: ["Crypto inventory", "PQC migration progress", "Critical-infrastructure protection"] },
      { name: "Environmental sustainability", desc: "The environmental footprint of quantum programs.", subs: ["Energy efficiency", "Green data centers & cooling", "Lifecycle & materials"] },
      { name: "Ethics & responsible use", desc: "Responsible, equitable and safe deployment.", subs: ["Governance & oversight", "Equitable access", "Dual-use safeguards"] },
    ],
  },
  gqa: {
    ...
    categoriesNote: "Open to SMEs and government entities worldwide. The international base categories are $1,000 to enter; full entity quantum-readiness assessment is $5,000.",
    categoryPrice: "$1,000",
    categoryPriceNote: "per category entry",
    assessmentPrice: "$5,000",
    categories: [
      { key: "initiative", name: "Best Initiative", desc: "The most impactful quantum or quantum-AI initiative delivered by an SME or government entity." },
      { key: "idea", name: "Best Idea", desc: "The boldest, most original quantum-AI idea with real potential to scale." },
      { key: "accelerator", name: "Best Accelerator", desc: "The program or accelerator doing the most to grow quantum talent and startups." },
      { key: "green", name: "Best Green Quantum-AI Idea", desc: "The idea using quantum-AI to advance sustainability and the UN SDGs." },
      { key: "government", name: "Best Government Programme", desc: "The public-sector strategy making a nation or region measurably more quantum-ready." },
      { key: "international", name: "International Open Category", desc: "Our global base category — open to any entity, anywhere, building real quantum capability." },
    ],
    guideTitle: "Award guidelines & criteria",
    guideNote: "Eligibility, categories, the AI-assessment process and how winners are chosen — the full handbook, open to read.",
    guideOpen: "Open the guidelines book",
    submitCtaCategory: "Submit to a category — $1,000",
    submit: {
      title: "Submit to the Global Quantum Award",
      note: "Tell us about your initiative. Our AI can help you rewrite it into a stronger submission, and gives you a preliminary score — then enter your category for $1,000.",
      ...
      titleField: "Submission title",
      summary: "Describe your initiative, impact and evidence",
      summaryPh: "What did you build, who does it help, what is the measurable impact, and how does it align to international standards?",
      docs: "Supporting documents (deck, evidence — PDF/images)",
      improve: "Improve with AI",
      improving: "AI is rewriting your draft…",
      improved: "AI-improved draft (edit freely):",
      score: "Get my AI readiness score",
      scoring: "AI is scoring your submission…",
      scoreLabel: "AI readiness score",
      verdictLabel: "AI assessment",
      pay: "Enter this category — $1,000",
      processing: "Setting up payment…",
      submitted: "Submission received. Our AI jury will assess it against the criteria and the results appear in the admin jury console.",
    },
    rubricTitle: "Award rubric — how entries are scored",
    rubricNote: "Every award and initiative is assessed by the neutral AI jury against seven weighted categories, each scored 0–100. The weighted total decides the shortlist; a human jury panel confirms the winners.",
    rubricScaleLabel: "Scoring bands",
    rubricScale: [
      { band: "Outstanding", range: "85–100" },
      { band: "Strong", range: "70–84" },
      { band: "Promising", range: "50–69" },
      { band: "Early", range: "0–49" },
    ],
    rubric: [
      { name: "Impact & outcomes", weight: "25%", desc: "Real, measurable results and who benefits.", subs: ["Measurable results", "Beneficiaries & reach", "Evidence of impact"] },
      { name: "Innovation & originality", weight: "20%", desc: "How novel and technically deep the work is.", subs: ["Novelty", "Technical depth", "Differentiation"] },
      { name: "Feasibility & execution", weight: "15%", desc: "Maturity and ability to deliver.", subs: ["Maturity / TRL", "Team & resources", "Delivery track record"] },
      { name: "Scalability & sustainability", weight: "15%", desc: "Path to scale and lasting value.", subs: ["Path to scale", "Financial sustainability", "UN SDG contribution"] },
      { name: "Standards alignment", weight: "10%", desc: "Alignment to international standards.", subs: ["NIST / ISO-IEC / IEEE / EU PQC", "Security-by-design", "Interoperability"] },
      { name: "Environmental responsibility", weight: "8%", desc: "Environmental footprint of the initiative.", subs: ["Energy efficiency", "Green operations"] },
      { name: "Ethics & responsible use", weight: "7%", desc: "Responsible, fair and safe by design.", subs: ["Governance & oversight", "Fairness & access", "Dual-use safeguards"] },
    ],
  },
  community: {
