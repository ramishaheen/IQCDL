          ...
          {!done ? (
            ...
            result && (
              ...
              >
                  ...
                  <div className="space-y-2.5">
                    {result.dimensions.map((d, i) => (
                      <div key={d.key} className="flex items-center gap-3">
                        <span className="w-28 shrink-0 text-xs text-slate-500 sm:w-36 sm:text-sm">
                        ...
                        <span className="w-9 shrink-0 text-end text-xs tabular-nums text-slate-600">
                          {d.pct}%
                        </span>
                      </div>
                    ))}
                ...
                <button
                  onClick={restart}
                  className="mx-auto mt-5 flex items-center gap-1.5 text-sm text-slate-500 transition hover:text-brand-600"
                >
