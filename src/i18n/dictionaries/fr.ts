...
const fr: DeepPartial<Dictionary> = {
  ...
  membership: {
    ...
    tiers: [
      { key: "community", name: "Communauté", desc: "19 $ une fois. Accès communauté, chat Guide Quantique IA, un cours en ligne gratuit, des fonctionnalités gratuites et 10 % de réduction sur les cours." },
    ...
    modalTitle: "Rejoindre la Communauté",
    modalNote: "19 $ une fois · paiement sécurisé via Stripe · inclut un cours en ligne gratuit et 10 % de réduction sur les cours.",
    nameLabel: "Nom complet",
    emailLabel: "E-mail",
    countryLabel: "Pays",
    pay: "Continuer vers le paiement sécurisé — 19 $",
