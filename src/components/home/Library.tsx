    ...
    pages: [
      ...
      },
      {
        ...
        lines: [
          ...
          "General entries: awards@iqcdl.org",
          "Ambassador applications: ambassadors@iqcdl.org",
          "Partnerships & sponsorship: partners@iqcdl.org",
        ],
      },
    ],
  },
    ...
    pages: [
      ...
      },
      {
        ...
        lines: [
          ...
          "Data access & licensing: data@iqcdl.org",
          "Methodology feedback: index@iqcdl.org",
          "Press requests: press@iqcdl.org",
        ],
      },
    ],
  },
  {
    ...
    pages: [
      ...
      },
      {
        title: "Apply",
        lines: [
          "Email: accreditation@iqcdl.org — include centre profile + country.",
          "Or: iqcdl.org/membership for community + indicative pricing.",
          "Pricing booklet: iqcdl.org/pricing.",
          "Ambassador route: ambassadors@iqcdl.org for partner-led onboarding.",
        ],
      },
    ],
  },
